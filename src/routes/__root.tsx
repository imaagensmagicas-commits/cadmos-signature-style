  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4 text-white">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-gray-400">
          Não conseguimos carregar esta página. Tente recarregar ou volte para o início.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md border border-gray-700 bg-transparent px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-gray-800"
          >
            Ir para o início
          </Link>
        </div>
